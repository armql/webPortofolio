...
export default function Navbar() {
    ...
    return (
        <div className="grid grid-cols-1">
            <div className="fixed z-10 top-100 right-0 left-0 h-40 grid-cols-2 items-start justify-end bg-white bg-opacity-60 backdrop-blur-md">
                <div className='grid grid-cols-1 lg:grid-cols-2 sm:gap-0 h-24 items-center justify-between text-3xl p-4 font-medium'>
