...
export default function Projects() {
    ...
    // const truncatedName = item.title.length > 28 ? item.name.substring(0, 28) + '...' : item.name;
        ...
        <div className=''>
            ...
            <div className='grid grid-cols-1 items-center justify-center bg-white backdrop-blur-lg bg-opacity-40'>
                ...
                <div className='grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 p-4 gap-6'>
                    {data.map((project) => (
                        <div key={project.id} className='grid grid-cols-1'>
                            <div className='w-full h-96 bg-white backdrop-blur-md bg-opacity-20'><img src="http://localhost:8000/src/layouts/Universal/images/WEBDEV.svg" alt="" className='scale-90'/></div>
                            <div className='p-2 text-center bg-white'>
                                <h1 className='font-bold tracking-tighter text-4xl'>{project.title}</h1>
